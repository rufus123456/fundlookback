...
class LookBack():
    ...
    def process(self,start_day,end_day,copy_amt):
        ...
        print('每月初定投:',copy_amt,'基金:',self.x_code,'开始时间:',start_day,'结束时间:',end_day,'基金总份数:',fund_copies,'涨幅:',round((round(fund_copies,2)*fund_close-total_amt)/total_amt,4))
